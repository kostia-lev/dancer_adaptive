...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    <?php
      ...
      hide($content['field_district']);
      hide($content['field_phone']);
      hide($content['field-dance-styleee']);
    ...
    <div style="width: 728px; height: 90px; margin-left:auto; margin-right:auto">
      ...
      <ins class="adsbygoogle"
           ...
           data-ad-client="ca-pub-7185293901417521"
           data-ad-slot="8250757294"></ins>
      <script>
    ...
    <?php
      ...
      print render($content['field_district']);
      print render($content['field-dance-styleee']);
