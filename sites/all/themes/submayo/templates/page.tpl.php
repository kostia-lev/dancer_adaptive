...
<?php
  ...
  if (theme_get_setting('menubar_background') == 1) $menubar_style = ' style=" background-color: ' . $menubar_bg_value . ';"';
	...
	drupal_add_js( drupal_get_path('theme', 'sub_mayo') . '/js/vendor/jqueryCheckBoxTree.js' );
...
<div id="page-wrapper" style="<?php echo $page_wrapper_style; ?>">
  <div id="page" style="<?php echo $page_style; ?>">
    ...
    <div class="section clearfix">
      ...
      <h1><?php print t('Все школы танцев Одессы'); ?></h1>
    ...
    <?php if ($main_menu || $secondary_menu) { ?>
      <div id="navigation"><div class="section">
		...
		<?php if('dancer.od.ua' == $_SERVER['SERVER_NAME']): ?>
<!-- Put this script tag to the <head> of your page -->
          <script type="text/javascript" src="//vk.com/js/api/openapi.js?115"></script>

          <script type="text/javascript">
            VK.init({apiId: 4603841, onlyWidgets: true});
          </script>

          <!-- Put this div tag to the place, where the Like block will be -->
          <div id="vk_like"></div>
          <script type="text/javascript">
            VK.Widgets.Like("vk_like", {type: "mini", pageUrl: "http://dancer.od.ua/dancelist"});
          </script>
          ...
          <script>(function(d, s, id) {
              ...
              js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=495201800595044&version=v2.0";
              fjs.parentNode.insertBefore(js, fjs);
            }(document, 'script', 'facebook-jssdk'));</script>

          <div class="fb-like" data-href="http://dancer.od.ua" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
		  <?php endif; ?>
    ...
    <div id="main" class="clearfix" style="<?php echo $main_style; ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <?php if ($title): ?><h1 class="title" id="page-title"><?php

            if(!empty($node) && field_get_items('node', $node, 'field_logo')){
                  $field_logo = field_get_items('node', $node, 'field_logo');
                  $schol_logo = field_view_value('node', $node, 'field_logo', $field_logo[0]);
                  echo "<img src='" . file_create_url($schol_logo['#item']['uri']) . "'>";
            }
  ...
  <div id="footer-wrapper" style="background-color: transparent">
      ...
      <?php if ($page['footer']) { ?>
          <div id="footer" style="background-color: transparent"><div class="section">
